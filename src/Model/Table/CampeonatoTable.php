...
class CampeonatoTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('bases')
            ->requirePresence('bases', 'create')
            ->notEmptyString('bases');

        $validator
            ->dateTime('fechaInicioInscripciones')
            ->requirePresence('fechaInicioInscripciones', 'create')
            ->notEmptyDateTime('fechaInicioInscripciones');

        $validator
            ->dateTime('fechaFinInscripciones')
            ->requirePresence('fechaFinInscripciones', 'create')
            ->notEmptyDateTime('fechaFinInscripciones');
