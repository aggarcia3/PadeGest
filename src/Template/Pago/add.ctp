...
<div class="pago form content">
    ...
    <h3 class="card-title text-center" style="color: black;">Hacerse Socio</h3>
        <?php
            echo $this->Form->control('esSocio',array('default'=>$esSocio, 'hidden'=>'true'));
            echo $this->Form->control('Número de Tarjeta');
            echo $this->Form->control('CVV / CVC', ['type' => 'number']);
            echo $this->Form->control('Fecha Vencimiento Tarjeta');
        ?>
